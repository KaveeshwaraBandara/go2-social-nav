...
# DOWNSTREAM CHANGE (go2-social-nav): upstream this pointed at a models/
# directory beside the source, populated by a manual curl per the README. Here
# the bundle is baked into the image at /opt/models by docker/Dockerfile, and
# the path is a single config constant ($GO2_HAND_LANDMARKER to override).
DEFAULT_MODEL_PATH = HAND_LANDMARKER_PATH
